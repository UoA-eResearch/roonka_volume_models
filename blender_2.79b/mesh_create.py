...
'''
Description: Creates convex hull models from all shapefiles contained within a specified directory. Comments are within the code to direct code alteracations.
